...
@NgModule({
  declarations: [VehiclesComponent, VehiclesListComponent, VehiclesListShellComponent],
  imports: [CommonModule, FormsModule, VehicleModule, CardModule, FavoritesModule],
